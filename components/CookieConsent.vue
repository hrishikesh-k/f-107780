<template>
  <div
    class="fixed bottom-0 flex w-full bg-white bg-opacity-90 backdrop-blur-lg shadow-2xl transition-transform duration-300 z-[2200000000]"
    :style="!popupOpen ? 'transform: translateY(100%)' : ''"
  >
