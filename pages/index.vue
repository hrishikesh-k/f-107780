					...
					<div class="flex flex-wrap sm:flex-nowrap gap-10">
						<div class="w-screen">
							<table class="table-fixed">
								<tbody>
									<tr>
										<td class="border-b border-gray-light pb-3 align-top">
											<strong>Basisverzorging door 1 persoon</strong><br />
											<em>samen met ondernemer/familie verzorgen en opbaren</em>
										</td>
										<td class="w-1/4 text-right border-b border-gray-light pb-3 align-top">€ 175,00</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="w-1/4 text-right border-b border-gray-light py-3 align-top">€ 0,27</td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<div class="flex flex-wrap sm:flex-nowrap items-top justify-center gap-10 p-2">
					...
					<div class="w-screen">
						<ul class="fa-ul flex space-x-4 font-sans text-white">
							...
							<li>
								<a href="https://www.facebook.com/Butter-Uitvaartservice-Post-Mortem-Support-108482781491035" class="text-4xl hover:text-orange transition-colors duration-300 animate" rel="noopener" target="_blank" aria-label="Facebook">
